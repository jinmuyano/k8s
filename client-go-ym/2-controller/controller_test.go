...
import (
	...
	"k8s.io/client-go/tools/cache"  //创建listandwatch,indexer,informer
	"k8s.io/client-go/tools/clientcmd"
	"k8s.io/client-go/util/homedir"
	"k8s.io/client-go/util/workqueue"   //创建workqueue
	"k8s.io/klog"
)
...
func initClient() (*kubernetes.Clientset, error) {
	...
	// 创建 Clientset 对象
	return kubernetes.NewForConfig(config)  //返回一个clientset对象
}

func TestController(* testing.T) {
	...
	controller := NewController(queue, indexer, informer)  //创建控制器
